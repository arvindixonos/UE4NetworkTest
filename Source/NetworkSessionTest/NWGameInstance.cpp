	...
	if (OnlineSub)
	{
		...
		if (Sessions.IsValid() && UserId.IsValid())
		{
			...
			*/
			...
			SessionSettings->Set(SETTING_MAPNAME, FString("GameLevel"), EOnlineDataAdvertisementType::ViaOnlineService);
...
void UNWGameInstance::StartOnlineGame()
{
	...
	HostSession(Player->GetPreferredUniqueNetId().GetUniqueNetId(), GameSessionName, false, true, 40);
}
